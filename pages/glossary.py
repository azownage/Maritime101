...
def show():
    ...
    # Extended glossary with 60+ terms
    glossary = {
        ...
        'CI': 'Crane Intensity - Ratio of quay cranes deployed per 1000 container moves',
        ...
        'Panamax': 'Vessel size able to transit Panama Canal (max ~5,000 TEU)',
        ...
        'Yard Block': 'Organized section of container yard',
        'VGM': 'Verified Gross Mass - Mandatory container weight verification'
    }
