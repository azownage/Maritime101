...
if page == "🏠 Home & Overview":
    ...
    from pages import global_trade
    global_trade.show()
elif page == "🚢 Vessels & Containers":
    from pages import vessels
    vessels.show()
elif page == "⚓ Port Operations":
    from pages import port_operations
    ...
    from pages import alliances
    alliances.show()
elif page == "🇸🇬 Singapore & Tuas":
    from pages import singapore
    singapore.show()
elif page == "🎯 CITOS & Technology":
    from pages import citos
    citos.show()
elif page == "💻 Digital Twin Guide":
    from pages import digital_twin
    digital_twin.show()
